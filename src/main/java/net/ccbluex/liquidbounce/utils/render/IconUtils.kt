...
object IconUtils {
    ...
    fun getFavicon() =
        IconUtils::class.java.runCatching {
            arrayOf(
                readImageToBuffer(getResourceAsStream("/assets/minecraft/liquidbounce/icon/icon_16x16.png")),
                readImageToBuffer(getResourceAsStream("/assets/minecraft/liquidbounce/icon/icon_32x32.png")),
                readImageToBuffer(getResourceAsStream("/assets/minecraft/liquidbounce/icon/icon_64x64.png"))
            )
        }.onFailure {
            it.printStackTrace()
        }.getOrNull()
